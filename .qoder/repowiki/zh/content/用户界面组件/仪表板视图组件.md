...
## 项目结构
本项目采用 Swift Package 组织方式，SwiftUI 视图位于 app/Codexling/Sources/Codexling 目录下。与仪表板相关的核心文件包括：
...
- 代码示例路径：
  - 仪表板布局与交互：[CompanionDashboardViews.swift](file://app/Codexling/Sources/Codexling/CompanionDashboardViews.swift)
  - 状态管理与订阅：[CompanionStores.swift](file://app/Codexling/Sources/Codexling/CompanionStores.swift)
  - 宠物数据模型：[PetModels.swift](file://app/Codexling/Sources/Codexling/PetModels.swift)
  - 使用统计模型与视图：[UsageModels.swift](file://app/Codexling/Sources/Codexling/UsageModels.swift)、[UsageViews.swift](file://app/Codexling/Sources/Codexling/UsageViews.swift)
  - 活动记录与服务：[CodexActivity.swift](file://app/Codexling/Sources/Codexling/CodexActivity.swift)、[CodexUsageService.swift](file://app/Codexling/Sources/Codexling/CodexUsageService.swift)
  - 应用设置：[AppSettings.swift](file://app/Codexling/Sources/Codexling/AppSettings.swift)