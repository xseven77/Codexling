...
关键目录与职责：
- app/Codexling：Swift 包定义、应用入口、资源与打包脚本
...
graph TB
subgraph "macOS 应用"
A["app/Codexling/Package.swift"]
B["app/Codexling/package_app.sh"]
C["app/Codexling/rebuild_and_run.sh"]
D["app/Codexling/release_app.sh"]
E["app/Codexling/scripts/run_chatgpt_api_probe.sh"]
end
subgraph "Web 落地页"
