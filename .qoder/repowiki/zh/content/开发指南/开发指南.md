...
- [CodexlingTests.swift](file://app/Codexling/Tests/CodexlingTests/CodexlingTests.swift)
...
## 简介
本指南面向开发者，覆盖 Codexling 的构建系统、依赖管理、开发环境配置、Swift Package Manager 配置与项目组织、开发脚本使用（重建运行、打包发布、自动化构建）、代码规范、测试策略、持续集成建议、调试技巧、性能分析与常见问题解决方案，以及贡献流程、代码审查与版本发布管理。目标是帮助你在本地高效开发、稳定构建与可靠发布。

## 项目结构
项目由两个主要子应用组成：
- macOS 原生应用（Swift）：位于 app/Codexling，包含 Swift 源码、资源、测试与脚本。
- 着陆页网站（Next.js）：位于 app/landing，用于产品落地页与下载入口。

```mermaid
graph TB
subgraph "macOS 应用 (Swift)"
A["Sources/Codexling"] --> B["Resources"]
A --> C["Tests/CodexlingTests"]
A --> D["scripts"]
E["Package.swift"] --> A
...
- [AppDelegate.swift:1-200](file://app/Codexling/Sources/Codexling/AppDelegate.swift#L1-L200)
- [AppSettings.swift:1-200](file://app/Codexling/Sources/Codexling/AppSettings.swift#L1-L200)
- [CompanionDashboardViews.swift:1-200](file://app/Codexling/Sources/Codexling/CompanionDashboardViews.swift#L1-L200)
- [SettingsViews.swift:1-200](file://app/Codexling/Sources/Codexling/SettingsViews.swift#1-L200)
- [UsageViews.swift:1-200](file://app/Codexling/Sources/Codexling/UsageViews.swift#L1-L200)
- [DetachedWindowController.swift:1-200](file://app/Codexling/Sources/Codexling/DetachedWindowController.swift#L1-L200)
- [StatusBarController.swift:1-200](file://app/Codexling/Sources/Codexling/StatusBarController.swift#L1-L200)
- [CodexActivity.swift:1-200](file://app/Codexling/Sources/Codexling/CodexActivity.swift#L1-L200)
- [CodexAPIProbe.swift:1-200](file://app/Codexling/Sources/Codexling/CodexAPIProbe.swift#L1-L200)
- [CompanionStores.swift:1-200](file://app/Codexling/Sources/Codexling/CompanionStores.swift#L1-L200)
- [PetModels.swift:1-200](file://app/Codexling/Sources/Codexling/PetModels.swift#L1-L200)
- [UsageModels.swift:1-200](file://app/Codexling/Sources/Codexling/UsageModels.swift#L1-L200)
- [ResetCouponFusionViews.swift:1-200](file://app/Codexling/Sources/Codexling/ResetCouponFusionViews.swift#L1-L200)
- [CodexlingTests.swift:1-200](file://app/Codexling/Tests/CodexlingTests/CodexlingTests.swift#L1-L200)
- [Info.plist:1-200](file://app/Codexling/Resources/Info.plist#L1-L200)
- [pet.json:1-200](file://app/Codexling/Resources/Pets/Codexling/pet.json#L1-L200)
...
- [CompanionStores.swift:1-200](file://app/Codexling/Sources/Codexling/CompanionStores.swift#L1-L200)
- [CompanionDashboardViews.swift:1-200](file://app/Codexling/Sources/Codexling/CompanionDashboardViews.swift#L1-L200)
- [SettingsViews.swift:1-200](file://app/Codexling/Sources/Codexling/SettingsViews.swift#L1-L200)
- [UsageViews.swift:1-200](file://app/Codexling/Sources/Codexling/UsageViews.swift#L1-L200)
- [DetachedWindowController.swift:1-200](file://app/Codexling/Sources/Codexling/DetachedWindowController.swift#L1-L200)
- [StatusBarController.swift:1-200](file://app/Codexling/Sources/Codexling/StatusBarController.swift#L1-L200)
- [CodexAPIProbe.swift:1-200](file://app/Codexling/Sources/Codexling/CodexAPIProbe.swift#L1-L200)
...
- 用例组织：CodexlingTests.swift 中按功能模块分组，优先覆盖关键路径与边界条件。
...
## 结论
本指南梳理了 Codexling 的开发环境与构建体系，明确了 Swift 与 Next.js 的职责边界与协作方式。遵循本文的流程与最佳实践，可有效提升开发效率与交付质量。
