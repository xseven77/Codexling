...
- [pet.json](file://app/Codexling/Resources/AppIcon.iconset/Pets/Codexling/pet.json)
...
## 项目结构
- 应用主体位于 app/Codexling，采用 Swift Package 组织代码与资源。
- 核心源码在 Sources/Codexling，涵盖应用入口、设置、状态存储、UI 视图、活动跟踪等。
- 资源位于 Resources，包含图标与宠物定义数据 pet.json。
- 文档位于 docs，包含状态计划、Dashboard 方向与 UI 刷新计划。
- 脚本位于根目录与 app/Codexling/scripts，用于构建、打包与发布。
