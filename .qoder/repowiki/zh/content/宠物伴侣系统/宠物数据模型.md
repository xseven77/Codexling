...
## 项目结构
- 应用代码位于 app/Codexling/Sources/Codexling/ 下，其中 PetModels.swift 承载宠物数据模型的核心实现。
- 宠物资源配置文件位于 app/Codexling/Resources/Pets/Codexling/pet.json，用于描述不同宠物类型的元数据与行为参数。
